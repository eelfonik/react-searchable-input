...
| theme | object |  <pre>{</br>disabledColor:"#DDDDDD",</br>inputHeight: "34px",</br>listMaxHeight: "500px",</br>listPadding: "20px",</br>listWidth: "100%",</br>listTop: "40px",</br>listLeft: "0px",</br>listBg: "transparent"</br>}</pre> | theme variables allow to custom the appearance of list)
